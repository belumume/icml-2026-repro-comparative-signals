"""N sweep at fixed low sigma, on the UNMODIFIED estimator. No monkeypatching anywhere.
...
OUT = "/kaggle/working/vr_nsweep_results.json"

RHO1, SIGMA_ETA, GAP, L = 0.8, 0.6, 0.05, 3
SIGMA = 0.08
NS = [1000, 4000, 16000]
REPS = 60
BUDGET_S = 6.5 * 3600  # comfortably under the session wall, unlike the last attempt
